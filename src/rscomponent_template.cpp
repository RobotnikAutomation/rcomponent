...
*/
RSComponent(ros::NodeHandle h) : self_test_(), diagnostic_(),
  ...
  command_freq_("Command frequency check", boost::bind(&RSComponent::checkCommandSubscriber, this, _1))  
{
    ...
    // joint_state_sub_ = private_node_handle_.subscribe<sensor_msgs::JointState>("/joint_commands", 1000, &RSComponent::cmdJointStateCallback, this);
